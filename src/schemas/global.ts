...
export const passwordSchema = Joi.string()
  ...
  .messages({
    ...
    "string.pattern.base":
      "Password must be 8-20 characters long and include at least: 1 number, 1 uppercase letter, 1 lowercase letter, and one special character (@$!#.%*?&_)",
  });
...
export const fullnameSchema = Joi.string()
  ...
  .messages({
    ...
    "string.pattern.base":
      "Account name must start with a letter or number and may contain letters, numbers, spaces, and -'.&, but cannot end with space or special characters",
  });
